...
half3 LightingPhysicallyBased(BRDFData brdfData, BRDFData brdfDataClearCoat,
    ...
    // #define _CUSTOM_SHADOWS_ON

    #ifdef _CUSTOM_SHADOWS_ON
    bool softShadows = lightAttenuation > 0.1 && lightAttenuation < 1.0; // TODO: configure this number
    float hardToSoft = lightAttenuation / 0.1;
    half3 shadowsColor = softShadows ? lerp(_SoftShadowsColor0, _SoftShadowsColor1, (lightAttenuation - 0.1) / 0.9) : lerp(_HardShadowsColor, _SoftShadowsColor0, hardToSoft);
    half3 radiance = lerp(shadowsColor, lightColor, lightAttenuation) * NdotL;
    #else
