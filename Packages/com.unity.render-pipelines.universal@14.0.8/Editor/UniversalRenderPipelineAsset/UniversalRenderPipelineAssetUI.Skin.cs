...
namespace UnityEditor.Rendering.Universal{
    internal partial class UniversalRenderPipelineAssetUI{
        internal static class Styles{
            ...
            public static GUIContent shadowFarCascadeSplitText = EditorGUIUtility.TrTextContent("Far Cascade Split", "The first 4 and the last 4 Cascade split points");
            public static GUIContent shadowMapClearPerFrame = EditorGUIUtility.TrTextContent("Shadowmap Clear Per Frame", "For each frame, either clear the last 4 Shadowmap cascades or just one of them.");
