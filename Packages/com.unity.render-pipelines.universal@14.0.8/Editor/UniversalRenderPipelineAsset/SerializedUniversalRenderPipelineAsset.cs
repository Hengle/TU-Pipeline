...
namespace UnityEditor.Rendering.Universal{
    internal class SerializedUniversalRenderPipelineAsset{
        ...
        // 新增4个Cascade
        public SerializedProperty shadowFarCascadeSplitProp { get; }
        public SerializedProperty shadowMapClearPerFrameProp { get; }
        public SerializedProperty shadowFarCascade2SplitProp { get; }
        public SerializedProperty shadowFarCascade3SplitProp { get; }
        public SerializedProperty shadowFarCascade4SplitProp { get; }
        ...
        public SerializedUniversalRenderPipelineAsset(SerializedObject serializedObject) {
            ...
            // 新增4个Cascade
            shadowFarCascadeSplitProp = serializedObject.FindProperty("m_ShadowFarCascadeSplit");
            shadowMapClearPerFrameProp = serializedObject.FindProperty("m_ShadowMapClearPerFrame");
            shadowFarCascade2SplitProp = serializedObject.FindProperty("m_FarCascade2Split");
            shadowFarCascade3SplitProp = serializedObject.FindProperty("m_FarCascade3Split");
            shadowFarCascade4SplitProp = serializedObject.FindProperty("m_FarCascade4Split");
