...
namespace UnityEngine.Rendering.Universal{
    ...
    public enum ShaderVariantLogLevel{
        ...
        [InspectorName("Only URP Shaders")] OnlyUniversalRPShaders,

        /// <summary>Logs all shader variants.</summary>
        [InspectorName("All Shaders")] AllShaders
    }
...
#pragma warning disable 618 // Obsolete warning
        [Obsolete("This is obsolete, please use shadowCascadeCount instead.", false)] [SerializeField]
        ...
        public ShadowCascadesOption shadowCascadeOption {
            get {
                switch (shadowCascadeCount) {
                    ...
                    // 添加8 Cascade
                    case 8: return ShadowCascadesOption.EightCascades;
            ...
            set {
                switch (value) {
                    ...
                    case ShadowCascadesOption.FourCascades:
                        ...
                        break;
                    case ShadowCascadesOption.EightCascades:
...
#pragma warning restore 618 // Obsolete warning
    ...
    public sealed partial class Bloom : VolumeComponent, IPostProcessComponent{
        ...
        /// </summary>
        [Obsolete("This is obsolete, please use maxIterations instead.", false)] [Tooltip("The number of final iterations to skip in the effect processing sequence.")]
