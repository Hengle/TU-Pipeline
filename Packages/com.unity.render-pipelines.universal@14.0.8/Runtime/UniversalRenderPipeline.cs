...
namespace UnityEngine.Rendering.Universal{
    ...
    public sealed partial class UniversalRenderPipeline : RenderPipeline{
        ...
        static void InitializeShadowData(UniversalRenderPipelineAsset settings, NativeArray<VisibleLight> visibleLights, bool mainLightCastShadows, bool additionalLightsCastShadows, bool isForwardPlus, out ShadowData shadowData) {
            ...
            // 遍历所有光源
            // 为ShadowBiasData和ShadowResolutionData添加改光源的阴影数据
            for (int i = 0; i < visibleLights.Length; ++i) {
                ref VisibleLight vl = ref visibleLights.UnsafeElementAtMutable(i);
                Light light = vl.light;
                ...
                // 根据光源的设置决定使用自定义阴影偏移还是渲染管线设置的阴影偏移
                if (data && !data.usePipelineSettings)
                    m_ShadowBiasData.Add(new Vector4(light.shadowBias, light.shadowNormalBias, 0.0f, 0.0f));
                else
                    m_ShadowBiasData.Add(new Vector4(settings.shadowDepthBias, settings.shadowNormalBias, 0.0f, 0.0f));

                // 根据光源的设置决定使用自定义阴影分辨率还是渲染管线设置的阴影分辨率
            ...
            // 将每个光源的ShadowBias和ShadowResolution赋值给shadowData
...
#pragma warning restore 0618
            ...
            // 设置主光源Shadow Resolution
            shadowData.mainLightShadowmapWidth = settings.mainLightShadowmapResolution;
            shadowData.mainLightShadowmapHeight = settings.mainLightShadowmapResolution;

            shadowData.mainLightShadowCascadesSplitArray = new float[settings.shadowCascadeCount];
            float farCascadeSplit = settings.shadowCascadeCount <= 4 ? 1.0f : settings.shadowFarCascadeSplit;
            // < 4
            switch (shadowData.mainLightShadowCascadesCount) {
                case 1:
                    shadowData.mainLightShadowCascadesSplitArray[0] = 1.0f * farCascadeSplit;
                    break;
                case 2:
                    shadowData.mainLightShadowCascadesSplitArray[0] = settings.cascade2Split * farCascadeSplit;
                    shadowData.mainLightShadowCascadesSplitArray[1] = 1.0f * farCascadeSplit;
                    break;
                case 3:
                    shadowData.mainLightShadowCascadesSplitArray[0] = settings.cascade3Split.x * farCascadeSplit;
                    shadowData.mainLightShadowCascadesSplitArray[1] = shadowData.mainLightShadowCascadesSplitArray[0] + settings.cascade3Split.y * farCascadeSplit;
                    shadowData.mainLightShadowCascadesSplitArray[2] = 1.0f * farCascadeSplit;
                    break;
                default:
                    shadowData.mainLightShadowCascadesSplitArray[0] = settings.cascade4Split.x * farCascadeSplit;
                    shadowData.mainLightShadowCascadesSplitArray[1] = shadowData.mainLightShadowCascadesSplitArray[0] + settings.cascade4Split.y * farCascadeSplit;
                    shadowData.mainLightShadowCascadesSplitArray[2] = shadowData.mainLightShadowCascadesSplitArray[1] + settings.cascade4Split.z * farCascadeSplit;
                    shadowData.mainLightShadowCascadesSplitArray[3] = 1.0f * farCascadeSplit;
                    break;
            }

            // > 4
            if (shadowData.mainLightShadowCascadesCount > 4) {
                float startSplit = settings.shadowFarCascadeSplit;
                switch (shadowData.mainLightShadowCascadesCount) {
                    case 5:
                        shadowData.mainLightShadowCascadesSplitArray[4] = 1.0f;
                        break;
                    case 6:
                        shadowData.mainLightShadowCascadesSplitArray[4] = startSplit + (1.0f - startSplit) * settings.farCascade2Split;
                        shadowData.mainLightShadowCascadesSplitArray[5] = 1.0f;
                        break;
                    case 7:
                        shadowData.mainLightShadowCascadesSplitArray[4] = startSplit + (1.0f - startSplit) * settings.farCascade3Split.x;
                        shadowData.mainLightShadowCascadesSplitArray[5] = shadowData.mainLightShadowCascadesSplitArray[4] + (1.0f - startSplit) * settings.farCascade3Split.y;
                        shadowData.mainLightShadowCascadesSplitArray[6] = 1.0f;
                        break;
                    default:
                        shadowData.mainLightShadowCascadesSplitArray[4] = startSplit + (1.0f - startSplit) * settings.farCascade4Split.x;
                        shadowData.mainLightShadowCascadesSplitArray[5] = shadowData.mainLightShadowCascadesSplitArray[4] + (1.0f - startSplit) * settings.farCascade4Split.y;
                        shadowData.mainLightShadowCascadesSplitArray[6] = shadowData.mainLightShadowCascadesSplitArray[5] + (1.0f - startSplit) * settings.farCascade4Split.z;
                        shadowData.mainLightShadowCascadesSplitArray[7] = 1.0f;
                        break;
                }
            }
            ...
            // shadowmap是否每帧刷新（针对后4帧）
            shadowData.clearPerFrame = settings.shadowMapClearPerFrame;
        }
