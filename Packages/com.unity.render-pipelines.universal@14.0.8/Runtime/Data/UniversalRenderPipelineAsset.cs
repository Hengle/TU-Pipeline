...
namespace UnityEngine.Rendering.Universal{
    ...
    public partial class UniversalRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver{
        ...
        [EditorBrowsable(EditorBrowsableState.Never)] [Obsolete("Use m_RendererDataList instead.")] [SerializeField]
        ...
        // 增加4 Cascade
        [SerializeField] private float m_ShadowFarCascadeSplit = 0.5f;
        [SerializeField] private bool m_ShadowMapClearPerFrame = false;
        [SerializeField] private float m_FarCascade2Split = 0.25f;
        [SerializeField] private Vector2 m_FarCascade3Split = new Vector2(0.1f, 0.3f);
        [SerializeField] private Vector3 m_FarCascade4Split = new Vector3(0.25f, 0.35f, 0.45f);
        ...
        [ShaderKeywordFilter.RemoveIf(false, keywordNames: ShaderKeywordStrings.SoftShadows)] [SerializeField]
        ...
        // 后4级Cascade的属性
        public float shadowFarCascadeSplit {
            get { return m_ShadowFarCascadeSplit; }
            internal set { m_ShadowFarCascadeSplit = value; }
        }

        public bool shadowMapClearPerFrame {
            get { return m_ShadowMapClearPerFrame; }
            internal set { m_ShadowMapClearPerFrame = value; }
        }

        public float farCascade2Split {
            get { return m_FarCascade2Split; }
            internal set { m_FarCascade2Split = value; }
        }

        public Vector2 farCascade3Split {
            get { return m_FarCascade3Split; }
            internal set { m_FarCascade3Split = value; }
        }

        public Vector3 farCascade4Split {
            get { return m_FarCascade4Split; }
            internal set { m_FarCascade4Split = value; }
        }
...
#pragma warning restore 618 // Obsolete warning
        ...
        public sealed class TextureResources{
            ...
            /// </summary>
            [Reload("Textures/BayerMatrix.png")] public Texture2D bayerMatrixTex;
