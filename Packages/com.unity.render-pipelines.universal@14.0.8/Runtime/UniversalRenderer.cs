...
namespace UnityEngine.Rendering.Universal {
    ...
    public enum RenderingMode {
        ...
        [InspectorName("Forward+")] ForwardPlus = 2,
    ...
    public sealed partial class UniversalRenderer : ScriptableRenderer {
        ...
        // TODO: 根据UI判断是否添加这两个Pass
        // 添加自定义的ScreenSpaceShadowsPass
        // private ScreenSpaceShadowsPass m_SSShadowsPass;
        // private ScreenSpaceShadowsPostPass m_SSShadowsPostPass; // 不知道干嘛用的，自带的ScreenSpaceShadows.cs里有
        ...
        // 用于清除ShadowMap的ComputeShader
        private const string m_ShadowMapCacheComputeName = "ShadowMapCacheCompute";
        ...
        public UniversalRenderer(UniversalRendererData data) : base(data) {
            ...
            // 创建ScreenSpaceShadows
            // m_SSShadowsPass = new ScreenSpaceShadowsPass(RenderPassEvent.AfterRenderingGbuffer);
            // m_SSShadowsPostPass = new ScreenSpaceShadowsPostPass(RenderPassEvent.BeforeRenderingTransparents);
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData) {
            ...
            // 加载清除ShadowMap的ComputeShader
            if (m_ShadowMapCacheCompute == null)
                m_ShadowMapCacheCompute = (ComputeShader)Resources.Load(m_ShadowMapCacheComputeName);
            if (m_ShadowMapCacheCompute == null) Debug.LogErrorFormat("{0}.Setup(): Missing computeShader. {1} render pass will not be added.", GetType().Name, m_ShadowMapCacheCompute.name);

            bool mainLightShadows = m_MainLightShadowCasterPass.Setup(ref renderingData, ref m_ShadowMapCacheCompute);
            ...
            // EnqueuePass(m_SSShadowsPass);
            // EnqueuePass(m_SSShadowsPostPass);
            // }
