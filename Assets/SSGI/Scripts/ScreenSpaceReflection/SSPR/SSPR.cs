...
namespace SSPR{
    ...
    internal class SSPRSettings{
        ...
        [SerializeField] [Range(0.0f, 0.1f)] internal float StretchIntensity = 0.0f;
        [SerializeField] [Range(0.0f, 1.0f)] internal float StretchThreshold = 0.1f;
        [SerializeField] internal float EdgeFadeOut = 0.2f;
        [SerializeField] internal LayerMask ReflectorLayer = 0;
    ...
    public class SSPR : ScriptableRendererFeature{
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData) {
            if (renderingData.cameraData.postProcessEnabled) {
                ...
                bool shouldAdd = mSSPRPass.Setup(ref mSettings, ref mComputeShader);
