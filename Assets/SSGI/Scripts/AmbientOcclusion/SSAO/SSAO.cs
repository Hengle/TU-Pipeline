...
namespace SSAO {
    ...
    public class SSAO : ScriptableRendererFeature {
        ...
        private const string mShaderName = "Hidden/SSGI/AO/SSAO";
    ...
    internal class SSAOPass : ScriptableRenderPass {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
            ...
            using (new ProfilingScope(cmd, mProfilingSampler)) {
                ...
                Blitter.BlitCameraTexture(cmd, mSSAOTexture0, mSSAOTexture0, mMaterial, 0);
