...
namespace HBAO {
    ...
    public class HBAO : ScriptableRendererFeature {
        ...
        private const string mShaderName = "Hidden/SSGI/AO/HBAO";
    ...
    internal class HBAOPass : ScriptableRenderPass {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
            ...
            using (new ProfilingScope(cmd, mProfilingSampler)) {
                ...
                Blitter.BlitCameraTexture(cmd, mHBAOTexture0, mHBAOTexture0, mMaterial, 0);
